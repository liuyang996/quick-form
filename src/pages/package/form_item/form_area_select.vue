<template>
    <!-- 普通输入框 -->
    <div :style="item.style || {}" :class="`form-unqiue-${item.key}`" class="form-input-box form-item-box">
        <!-- 这是三级联动选择框 -->
        <el-row v-if="!getTextModel">
            <el-col :span="8">
                ...
                >
                    <el-option
                        v-for="items in dynamicDict[item.firstParentKey || '10020']"
            ...
            <el-col :span="8">
                <el-select v-model="val[2]" class="select" placeholder="请选择" :disabled="getDisabled">
                    <el-option
